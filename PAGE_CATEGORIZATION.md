...
- **File**: `src/pages/ProductCatalog.js`
- **Truy cập**: Tất cả người dùng
...
- **File**: `src/pages/ShoppingCart.js`
- **Quyền**: Customer only
...
- **File**: `src/pages/OrderConfirmation.js`
- **Quyền**: Customer only
...
- **File**: `src/pages/FeedbackForm.js`
- **Quyền**: Customer only
...
Tất cả các trang được bảo vệ bằng component `ProtectedRoute` trong `src/components/ProtectedRoute.js`:
